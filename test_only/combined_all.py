...
def dict_to_csv(feature_dict):
    for k in feature_dict:
        filename = 'short_set' + str(k) + '.csv'
        with open(filename,'w') as csvfile:
            writer = csv.writer(csvfile, delimiter=',')
            writer.writerow(["essay_id", "set", "score", "org_score", "pos_adjadv", "pos_noun", "pos_pronoun", "pos_verb", "pos_other", "pos_nums", "complex_short", "complex_medium", "complex_long", "vocab_level","pred_score","prompt_relevence"])
